...
if __name__ == '__main__':
    ...
    parser.add_argument('--filePath', type=str,
                        default='/home/yuankun/Desktop/MnDOT/python_proj_haoji/MNDot/signal_data_JulSep2023/', help='path of multiple files')
    parser.add_argument('--output_filePath', type=str,
                        default='/home/yuankun/Desktop/MnDOT/python_proj_haoji/MNDot/sorted_data/', help='the output file path')
