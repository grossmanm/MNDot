...
if __name__ == '__main__':
    ...
    parser.add_argument('--startdt', type=str,
                        default='2023-01-04 00:00:00.000', help='the start datetime')
    parser.add_argument('--enddt', type=str,
                        default='2023-01-11 00:00:00.000', help='the end datetime')
    parser.add_argument('--threshold', type=float,
                        default=-0.8, help='the threshold of pearson correlation to define strong negetive correlation')
    parser.add_argument('--input_file', type=str,
                        default='/home/yuankun/Desktop/MnDOT/2023/10-highrez-analysis/output-stat-51-22Dec23Jan.json', help='the input file')
    parser.add_argument('--output_GTcorr_file', type=str,
                        default='/home/yuankun/Desktop/MnDOT/2023/10-highrez-analysis/output-detected-51-22Dec23Jan-20230104-20230111-allGroundTruthPearson.json', help='the output file of all GroundTruth pearson')
    parser.add_argument('--output_NITcorr_file', type=str,
                        default='/home/yuankun/Desktop/MnDOT/2023/10-highrez-analysis/output-detected-51-22Dec23Jan-20230104-20230111-allNITPearson.json', help='the output file of all NIT pearson')
    parser.add_argument('--output_GTanomalyhours_with_pearson', type=str,
                        default='/home/yuankun/Desktop/MnDOT/2023/10-highrez-analysis/output-detected-51-22Dec23Jan-20230104-20230111-thresn08-GroundTruthanomalyhours_with_pearson.json', help='')
    parser.add_argument('--output_NITanomalyhours_with_pearson', type=str,
                        default='/home/yuankun/Desktop/MnDOT/2023/10-highrez-analysis/output-detected-51-22Dec23Jan-20230104-20230111-thresn08-NITanomalyhours_with_pearson.json', help='')
    parser.add_argument('--output_file1', type=str,
                        default='/home/yuankun/Desktop/MnDOT/2023/10-highrez-analysis/output-detected-51-22Dec23Jan-20230104-20230111-thresn08-seperateHours.json', help='the output file 1 - seperate anomaly datehours')
    parser.add_argument('--output_file2', type=str,
                        default='/home/yuankun/Desktop/MnDOT/2023/10-highrez-analysis/output-detected-51-22Dec23Jan-20230104-20230111-thresn08-combinedHours.json', help='the output file 2 - combined anomaly datehours with IDs')
